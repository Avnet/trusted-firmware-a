...
void rz_io_setup(void)
{
	...
	if (boot_dev == BOOT_MODE_SPI_1_8 ||
		...
		/*spi_multi_setup(SPI_MULTI_ADDR_WIDES_24, SPI_MULTI_DQ_WIDES_1_4_4, SPI_MULTI_DUMMY_6CYCLE);*/
		spi_multi_setup(SPI_MULTI_ADDR_WIDES_24, SPI_MULTI_DQ_WIDES_1_1_4, SPI_MULTI_DUMMY_8CYCLE);
